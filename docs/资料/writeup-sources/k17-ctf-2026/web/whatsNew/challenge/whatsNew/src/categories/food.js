...
function renderPost(post) {
  return `
    <article class="post-card" data-category="food" data-post-id="${raw(post.id)}">
      <header>
...
module.exports = {
  ...
  fields: [
    ...
    { name: 'description', label: 'Description', type: 'textarea', placeholder: 'Short review', maxLength: 200 },
